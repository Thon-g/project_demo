...
import yoot.project_demo.config.AppJwtProperties;
...
import yoot.project_demo.repository.RefreshTokenSessionRepository;
import yoot.project_demo.repository.UserRepository;
import yoot.project_demo.security.JwtService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public CurrentUserResponse me(String username) throws BadRequestException {
        return toCurrentUserResponse(findActiveUserByUsername(username));
    }

    @Transactional(readOnly = true)
    public User findActiveUserByUsername(String username) throws BadRequestException {
        User user = userRepository.findByUsername(username)
